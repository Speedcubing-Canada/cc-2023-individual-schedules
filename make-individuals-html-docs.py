...
if __name__ == '__main__':
    with open('./public/index.html', 'r') as f:
        ...
        for line in f.readlines():
            ...
            if start_new_file:
                ...
                current_write_file = f'./public/{result.group(1)}'
    ...
    shutil.copy('./public/style.css', './public/person') # loading css from a lower path is difficult - just duplicate the stylesheet in the persons/ dir